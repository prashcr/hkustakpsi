...
var akpsiController = require('./controllers/akpsi');
...
app.get('/brothers/:id', akpsiController.getBrother);
app.get('/brothers', akpsiController.getBrothers);
app.get('/about', akpsiController.getAbout);
app.get('/recruitment', akpsiController.getRecruitment);
